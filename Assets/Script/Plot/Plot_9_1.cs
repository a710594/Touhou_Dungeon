...
public class Plot_9_1
{
    private bool _uuzGetNoDamage = false; //uuz 在無敵狀態中被攻擊
    private bool _summonGhost = false; //uuz 剩一條血的時候召喚幽靈
    private bool _uuzLastHP = false; //uuz 剩最後一條血的時候
    ...
    private void UuzGetNoDamage(Action callback) //uuz 無敵狀態中被打,提醒玩家先去打幽靈
    {
